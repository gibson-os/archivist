...
class PasswordStrategy implements AudibleStrategyInterface, PriorityInterface
{
    ...
    public function execute(Session $session, Account $account): bool
    {
        ...
        $session->getPage()->pressButton('signInSubmit');
    ...
    {
        return $session->getPage()->findById('password') !== null;
    }
